...
dag = DAG(
    "dag_57", #same name as application. and there should be no underscore in application name
...
submit_spark_job = SparkKubernetesOperator(
    task_id="submit_spark_dag_57", #NOT but in blog
    executor_config={
        "env": {
...
wait_for_spark_app = SparkAppSensor(
    task_id="wait_for_spark_app57",
    namespace="default",
    task_id_prefix="submit-dag-57",  # Matches the SparkApplication name prefix
