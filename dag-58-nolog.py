...
dag = DAG(
    "dag_58", #same name as application. and there should be no underscore in application name
...
submit_spark_job = SparkKubernetesOperator(
    task_id="submit_spark_dag_58", #NOT but in blog
    executor_config={
        "env": {
...
wait_for_spark_app = SparkAppSensor(
    task_id="wait_for_spark_app58",
    namespace="default",
    task_id_prefix="submit-dag-58",  # Matches the SparkApplication name prefix
