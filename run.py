...
spec = {
  ...
  "spec": {
    ...
    "sparkConf": {
      ...
      "spark.eventLog.dir": "wasb://spark-logs@airflowlogsm7alhy.blob.core.windows.net/spark-logs",
      "spark.kubernetes.authenticate.driver.serviceAccountName": "spark",
      "spark.hadoop.fs.azure.account.key.airflowlogsm7alhy.blob.core.windows.net": "IUiS3HP8yAyR0ezKRYfi3daJ6n/vMRnIPA4nK35qgP29yLht3Vlc96XjWkbroOxHz3s6oK2D93v9+AStQN4Q9A=="
    },
    "driver": {
      "cores": 1,
      "memory": "512m",
...
dag = DAG(
    "adag_41", #same name as application. and there should be no underscore in application name
...
submit_spark_job = SparkKubernetesOperator(
    task_id="submit_spark_adag_41", #NOT but in blog
    executor_config={
        "env": {
