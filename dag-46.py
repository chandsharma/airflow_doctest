...
spec = {
  ...
  "spec": {
    ...
    "sparkConf": {
      ...
      "spark.eventLog.dir": "wasb://spark-logs@sparklstoragelmxbba.blob.core.windows.net/spark-logs",
      "spark.kubernetes.authenticate.driver.serviceAccountName": "spark",
      "spark.hadoop.fs.azure.account.key.sparklstoragelmxbba.blob.core.windows.net": "oBoBfm1taLBHwH38NQJLPRsVPcbFw2mhp3/La9dkuJEW5s5kh9v8ZUxJZEmJQUJfgmQKZ25QsMAo+AStp0Q0tw=="
    },
    "driver": {
      "cores": 1,
      "memory": "512m",
...
dag = DAG(
    "dag_46", #same name as application. and there should be no underscore in application name
...
submit_spark_job = SparkKubernetesOperator(
    task_id="submit_spark_dag_46", #NOT but in blog
    executor_config={
        "env": {
