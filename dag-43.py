...
spec = {
  ...
  "spec": {
    ...
    "sparkConf": {
      ...
      "spark.eventLog.dir": "wasb://spark-logs@sparklstorage6370wo.blob.core.windows.net/spark-logs",
      "spark.kubernetes.authenticate.driver.serviceAccountName": "spark",
      "spark.hadoop.fs.azure.account.key.sparklstorage6370wo.blob.core.windows.net": "JPU3h6uNCWtsN7h6Qj9Pcxbik1JbFdwjM+vTI/OTdkt89UNHGURnixAdUyjwvhti74h+rd86wVBl+AStzVY+CA=="
    },
    "driver": {
      "cores": 1,
      "memory": "512m",
...
dag = DAG(
    "dag_43", #same name as application. and there should be no underscore in application name
...
submit_spark_job = SparkKubernetesOperator(
    task_id="submit_spark_dag_43", #NOT but in blog
    executor_config={
        "env": {
