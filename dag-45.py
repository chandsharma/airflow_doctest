...
spec = {
  ...
  "spec": {
    ...
    "sparkConf": {
      ...
      "spark.eventLog.dir": "wasb://spark-logs@sparklstorage7uior5.blob.core.windows.net/spark-logs",
      "spark.kubernetes.authenticate.driver.serviceAccountName": "spark",
      "spark.hadoop.fs.azure.account.key.sparklstorage7uior5.blob.core.windows.net": "i7tsI2mWh79ryaj1VBJwyfeOYnynwd1pT3ZfzsioU9eKls9I1+6cXwuU4bF5fB2KpyFINCkw9U8q+AStnBQJ/w=="
    },
    "driver": {
      "cores": 1,
      "memory": "512m",
...
dag = DAG(
    "dag_45", #same name as application. and there should be no underscore in application name
...
submit_spark_job = SparkKubernetesOperator(
    task_id="submit_spark_dag_45", #NOT but in blog
    executor_config={
        "env": {
