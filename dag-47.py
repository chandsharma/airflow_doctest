...
spec = {
  ...
  "spec": {
    ...
    "sparkConf": {
      ...
      "spark.eventLog.dir": "wasb://spark-logs@airflowlogsmc5mbc.blob.core.windows.net/spark-logs",
      "spark.kubernetes.authenticate.driver.serviceAccountName": "spark",
      "spark.hadoop.fs.azure.account.key.airflowlogsmc5mbc.blob.core.windows.net": "aB91FcQVEtpyXcHmLivqR+PplGBguH9krkWUByHjbajiFycjEiStiboOjZ2g2Z/+ZLwDxnFGLXJm+AStV4IFTQ=="
    },
    "driver": {
      "cores": 1,
      "memory": "512m",
...
dag = DAG(
    "dag_47", #same name as application. and there should be no underscore in application name
...
submit_spark_job = SparkKubernetesOperator(
    task_id="submit_spark_dag_47", #NOT but in blog
    executor_config={
        "env": {
